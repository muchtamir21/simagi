    ...
    <div class="row align-item-center">
        ...
        <table  class="table align-items-center table-flush myTable">
                    ...
                    <tbody>
                        ...
                        $daftar_usulan = $this->m_dashboard->usulan_dirut()->result();
                        $no=0;
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url() ?>simagi/dirut/detail_dirut/<?php echo $rec->idusulan ?>" class="btn btn-info btn-sm">Detail</a>
