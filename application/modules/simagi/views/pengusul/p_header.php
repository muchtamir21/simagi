     ...
     <div class="sidenav-header  align-items-center bg-primary" >
      ...
      <div class="navbar-inner">
        ...
        <!-- Nav items -->
          ...
          <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('simagi/pengusul/usulankegiatan_p'); ?>">
                <i class="ni ni-single-copy-04 text-white"></i>
                  <span class="nav-link-text text-white">Pengguna Usulan Kegiatan</span>
                </a>
          </li>
          
          <li class="nav-item active">
          <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('simagi/pengusul/tambahusulan_p'); ?>">
                <i class="ni ni-archive-2 text-white"></i>
                  <span class="nav-link-text text-white">Pengguna Tambah Usulan</span>
                </a>
          </li>
              ...
              <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
                ...
                <div class="list-group list-group-flush">
                      ...
                      foreach ($catatan as $rows ) {
                        # code...
                      $usuln = $this->m_dashboard->where('usulankegiatan',['idusulan' => $rows->idusulan, 'id_user' => $this->session->userdata('id_user') ])->row();
                      if(empty($usuln)){}else{
                       ?>
                      
                      
                      <a href="<?php echo base_url() ?>simagi/pengusul/validasi_notif/<?php echo $rows->idusulan ?>" class="list-group-item list-group-item-action" <?php if($rows->notif=='0'){ ?> style="background: #ddd" <?php } ?> >
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    ...
                    $penggunas = $this->m_dashboard->where('pengguna',['idpengguna' => $this->session->userdata('id_user') ])->row();
                    echo $penggunas->namapengguna;
                      ?></span>
                  </div>
                </div>
              </a>
