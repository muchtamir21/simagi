...
<div class="card shadow">
 ...
 <?php
        ...
        Tolak</button>
        <button type="button"  class="btn btn-default float-right" data-target="modal" disabled   >Validasi</button>
...
<div id="modaltolak" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" action="<?php echo base_url() ?>simagi/ppk/tolakusulan/<?php echo $usulan->idusulan ?>" method="POST"  >
...
<div id="modalvalidasi" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <center>
      ...
      <a href="<?php echo base_url() ?>simagi/ppk/validasi_ppk/<?php echo $usulan->idusulan ?>" type="submit" class="btn btn-success" data-target="modal"  >Validasi</a>
